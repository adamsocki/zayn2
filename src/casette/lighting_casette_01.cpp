...
void UpdateUniformBuffer_LightingCasette_01(uint32_t currentImage, ZaynMemory *zaynMem, vec3 lightColor)
{
    Camera *cam = &Zayn->camera;

    UniformBufferObject_lighting_01 ubo = {};
...
void UpdateRender_LightingCasette()
{
    if (BeginFrame())
    {
        ...
        UpdateUniformBuffer_LightingCasette_01(Zayn->vkCurrentFrame, Zayn, lightColor);
